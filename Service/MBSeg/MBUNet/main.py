...
from Service.MBSeg.MBUNet.MBUNetWrapper import MBUNetWrapper
...
class MBUNetController:
    @staticmethod
    @app.post("/run/mb/seg/unet")
    async def run(file: fastapi.UploadFile):
        ...
        try:
            ...
            async with async_lock:
                ...
                cache_path = os.path.join(AppConfig.CACHE_PATH, "mb-seg-unet", now_time)
